...
JSONClient.prototype.del = function(path, callback) {
    this.call(path, { method: 'DELETE' }, callback);
};

/* not in restify */
JSONClient.prototype.upload = function(path, filename, contentType, contents, callback) {
    ...
    this.call(path, { method: 'POST', formData: formData }, callback);
}
